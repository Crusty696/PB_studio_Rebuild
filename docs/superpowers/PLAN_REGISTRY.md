...
| `PB-STUDIO-AREA-AUDIT-2026-05-24` | `docs/superpowers/plans/2026-05-24-pb-studio-area-audit/` | `C:\Brain-Bug\projects\pb-studio\wiki\synthesis\plan-pb-studio-area-audit-2026-05-24.md` | `C:\Brain-Bug\projects\pb-studio\wiki\decisions\D-052-pb-studio-area-audit.md` | `approved-for-implementation` | Area 2: Database, Migrations, Storage, Soft-Delete. | Audit-only plan: no app-code changes or fixes until user approves a later fix plan; existing dirty worktree changes must be preserved. |
