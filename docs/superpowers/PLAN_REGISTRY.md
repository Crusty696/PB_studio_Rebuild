...
| `PB-STUDIO-AREA-AUDIT-FIXPLAN-2026-05-25` | `docs/superpowers/plans/2026-05-25-pb-studio-area-audit-fixplan/` | `C:\Brain-Bug\projects\pb-studio\wiki\synthesis\plan-pb-studio-area-audit-fixplan-2026-05-25.md` | `C:\Brain-Bug\projects\pb-studio\wiki\decisions\D-053-pb-studio-area-audit-fixplan.md` | `approved-for-implementation` | Task 44: B-406 Proxy task label says NVENC but command uses libx264. | Fix only documented audit bugs B-348 through B-430; no unrelated refactors or feature work. |
