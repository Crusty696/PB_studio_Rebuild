...
| `PB-STUDIO-AREA-AUDIT-FIXPLAN-2026-05-25` | `docs/superpowers/plans/2026-05-25-pb-studio-area-audit-fixplan/` | `C:\Brain-Bug\projects\pb-studio\wiki\synthesis\plan-pb-studio-area-audit-fixplan-2026-05-25.md` | `C:\Brain-Bug\projects\pb-studio\wiki\decisions\D-053-pb-studio-area-audit-fixplan.md` | `approved-for-implementation` | Task 43: B-405 Batch convert allows AV1 on GTX1060 target. | Fix only documented audit bugs B-348 through B-430; no unrelated refactors or feature work. |
