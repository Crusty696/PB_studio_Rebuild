...
```text
OTK-017 completed 2026-06-10 (11 bugs fixed, B-469 parked). Next task = user
selection among remaining open OTK tasks (OTK-005, OTK-007, OTK-018, OTK-019,
OTK-021, OTK-022) or triage of new findings B-490 / B-491.
```
...
| OTK-018 | 3 | AUDIO-ANALYSIS-V2-STRICT-SEQUENTIAL-2026-05-17 | approved-for-planning | P0 Freeze And Snapshot before any Audio-V2 port; sandbox branch dirty/old, direct merge forbidden. 2026-06-11: P0 Freeze/Snapshot DONE (git-verified: current branch has no `services/audio_pipeline/` = no port; sandbox HEAD `2cd9ca1`, doc HEAD `6f414dd` is ancestor; `perf_watchdog.py` still merge-conflict = merge stays forbidden). No code/merge/port. Bucket-A port = next separate user-started task. Synthesis `wiki/synthesis/otk-018-audio-v2-p0-freeze-snapshot-2026-06-11.md`. | Registry. | p0-freeze-done-port-pending |
| OTK-019 | 3 | VIDEO-PIPELINE-ENGINE-2026-05-19 | approved-for-implementation | Filled checklist reports PARTIAL: outputs present/rendered, import and analysis already at 100 percent, timeline 768 clips, stems, beats/BPM 143.6, logs no errors. Still open: fresh end-to-end pipeline rerun with live progress and plan-doc phase determination. 2026-06-11: fresh service-layer E2E rerun on GTX 1060 = 17/18 PASS, 0 FAIL, 1 SKIP (stems by flag); video pipeline Scene+RAFT+SigLIP, semantic search, Pacing-Gemma, Auto-Edit (193 cut-points) all green. Still GUI/user-acceptance only: proxy-playback, keyframe sight-check, resume-mid-kill, 4h long-form coverage, V2-coexistence (90_LIVE_VERIFY steps 2/4/9/10/11). Synthesis `wiki/synthesis/live-verify-video-pipeline-2026-06-11.md`. | Registry; plan `99_OPEN_QUESTIONS.md`; `90_LIVE_VERIFY.md`; `C:\Users\David Lochmann\Desktop\PB-Studio-Pruefcheckliste-2026-06-09-AUSGEFUELLT.md` | partial-live-verification |
...
| OTK-021 | 3 | GLOBAL-STORAGE-PROVENANCE-2026-05-19 | approved-for-planning | Planning/review only until prerequisites; open implementation/live-verify plan files remain. 2026-06-11: prerequisite-block confirmed — plan requires "Plan A+B Tier 1-2 done OR user V2 live-verify"; none met (video-pipeline still partial, audio-V2 only P0-frozen not ported, no user V2 live-verify). Implementation must NOT start. Synthesis `wiki/synthesis/otk-021-storage-provenance-prereq-block-2026-06-11.md`. | Registry. | blocked-prerequisite |
