...
# AUFRAEUM B2: Reine, GPU-freie Caption-Validierungs-Helper ausgelagert nach
# services/video_analysis/caption_validation.py (verbatim). Re-Export haelt die
# Public-API (``from services.video_analysis_service import
# _caption_text_is_plausible, _validate_caption_dict``) unveraendert.
from services.video_analysis.caption_validation import (  # noqa: E402
