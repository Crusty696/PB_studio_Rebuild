...
# AUFRAEUM B4 (konservativer God-Object-Split): reine QSS-/Farb-Konstanten
# nach ``ui/workspaces/media/styles.py`` ausgelagert und hier re-exportiert.
# Public-API unveraendert (Modul-Attribute bleiben unter gleichem Namen),
# reiner Verbatim-Move ohne Logik-Change.
from ui.workspaces.media.styles import (  # noqa: E402  (re-export)
    _MODE_BTN_STYLE,
    _VIEW_TOGGLE_STYLE,
    _CARD_STYLE,
    _CARD_TITLE_STYLE,
